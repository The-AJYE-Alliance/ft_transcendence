...
class Match(models.Model):
	...
	player_1 = models.CharField(max_length=30, blank=False, null=False)
	player_2 = models.CharField(max_length=30, blank=False, null=False)
...
# PAS A S'OCCUPER POUR L'INSTANT 
...
# 	current_match = models.ForeignKey(Match, on_delete=models.CASCADE, null=True)
